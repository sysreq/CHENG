...
// Issue #27, #144 (control surfaces), #154 (parameter renaming), #217 (tail airfoil T23)
// ============================================================================
  ...
  return (
    <div className="p-3">
      ...
      <ParamSelect
        ...
        title="Airfoil profile for all tail surfaces. NACA-0012 is the default. Thinner profiles (0006, 0009) reduce drag. Flat-Plate suits micro/foamy builds."
      />
